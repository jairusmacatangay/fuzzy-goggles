...
namespace VitasysEHR.DataAccess.Migrations
{
    ...
    [Migration("20220123163143_AddTreatmentRecordToothToDb")]
    partial class AddTreatmentRecordToothToDb
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ToothTreatmentRecord", b =>
                {
                    ...
                    b.HasKey("TeethId", "TreatmentRecordsId");

                    b.HasIndex("TreatmentRecordsId");

                    b.ToTable("ToothTreatmentRecord");
                });
            ...
            modelBuilder.Entity("ClinicPatient", b =>
                {
                    b.HasOne("VitasysEHR.Models.Clinic", null)
                        .WithMany()
                        .HasForeignKey("ClinicsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VitasysEHR.Models.Patient", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ToothTreatmentRecord", b =>
                {
                    b.HasOne("VitasysEHR.Models.Tooth", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VitasysEHR.Models.TreatmentRecord", b =>
                {
                    b.HasOne("VitasysEHR.Models.Encounter", "Encounter")
                        .WithMany()
